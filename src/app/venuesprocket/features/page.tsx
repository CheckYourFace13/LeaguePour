...
const modules = [
  ...
  },
  {
    ...
    body: "Customers sign from their phone. No DocuSign subscription needed. The contract is legally recorded with timestamp and IP.",
  },
  {
    id: "deposits",
  ...
  },
  {
    ...
    href: "/beo-software",
    features: [
      "Event name, date, time, guest count, contact info carry over automatically",
      "Room setup, food, beverage, staffing, and AV sections built into the editor",
      "Timeline builder",
