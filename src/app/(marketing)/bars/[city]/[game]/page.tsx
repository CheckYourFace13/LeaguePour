...
export async function generateMetadata({
  ...
  return buildCityDiscoveryMetadata("bars", city, game);
}

export default async function BarsCityGamePage({
  params,
}: {
  params: Promise<{ city: string; game: string }>;
}) {
  const { city, game } = await params;
  return <CityDiscoveryPage prefix="bars" citySlug={city} gameSlug={game} />;
}
