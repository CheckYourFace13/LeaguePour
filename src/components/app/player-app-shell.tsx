  ...
  return (
    <div className="min-h-full bg-lp-bg">
      <div className="flex min-h-full">
        <aside className="hidden w-64 shrink-0 flex-col border-r border-lp-border-strong bg-lp-surface md:flex">
          <div className="border-b border-lp-border-strong px-5 py-5">
            <Link href={playerAppRoutes.dashboard} className="font-display text-[1.45rem] font-extrabold tracking-tight">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-40 flex items-center justify-between border-b border-lp-border-strong bg-lp-surface px-4 py-3.5 backdrop-blur md:hidden">
            <span className="font-display text-[1.35rem] font-extrabold">Player</span>
            <button
              type="button"
              className="inline-flex size-[3.2rem] items-center justify-center rounded-[10px] border border-lp-border-strong bg-lp-surface"
